...
bash travis/travis_retry.sh sudo apt-add-repository 'deb https://dl.winehq.org/wine-builds/ubuntu/ xenial main'
...
bash sudo apt-get install -y winehq-devel winetricks
